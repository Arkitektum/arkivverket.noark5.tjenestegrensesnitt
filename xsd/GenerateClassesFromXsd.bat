...
set xsdfiles=vsm103.xsd rest.xsd admin103.xsd loggingogsporing103.xsd metadata103.xsd moeteogutvalgsbehandling103.xsd sakarkiv103.xsd  MatrikkelFelles.xsd PlanFelles.xsd Geometri.xsd Kodeliste.xsd .\arkivstruktur103.xsd
